...
@Service
public class ImageUpoadServiceImplementation implements ImageUploadService {
    ...
    private int checkDocumentStatus(int cid, String type) {
        ...
        List<Documents> result = docRepo.findByCustomerIdAndDocumentTypeAndDocStatus(cid, type,
                ConstantFile.STATUS_ACTIVE);
